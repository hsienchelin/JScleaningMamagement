...
//     1-2 三節慰問金    2,000 × 3 節 × 3 人  =    18,000   →   1,500 / 月（年攤）
...
//   115 年度總額：126,812 × 12 + 149,265 = 1,521,744 + 149,265 = 1,671,009
//   （與 PDF 拆分 1,671,007 差 2 元，源自材機 53,770/12 捨入）
...
const site = {
  ...
  monthlyItems: [
    ...
    monthlyItem('三節慰問金月攤（3 人 × 3 節 × 2,000 ÷ 12）', 1500),
...
const contractData = {
  ...
  sites:         [site],
  amendments:    [],
  notes:         '經議價後調整。採輪休每日安排至少 2 人、工時 08:00-17:00。員工月薪不低於 32,450 元（配合 115 年基本薪資調漲）。合約金額 1,671,007 元為未稅小計（不含行政管理費 10% 與營業稅 5%）。',
  createdAt: serverTimestamp(),
}
