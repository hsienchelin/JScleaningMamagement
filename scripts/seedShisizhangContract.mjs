...
//   115 年度總額：124,662 × 12 + 149,265 = 1,495,944 + 149,265 = 1,645,209
//   （與 PDF 拆分 1,645,207 差 2 元，源自材機 53,770/12 捨入）
//
// 註：以下項目不放 monthlyItems，依各自時機另外處理：
//   1-2 三節慰問金   18,000 → 薪資頁逐節
//   1-3 勞工健康檢查  3,000 → 薪資頁
//    3  機動人力     4,800 → 實作實算，發生時走機動派工
...
const contractData = {
  ...
  sites:         [site],
  amendments:    [],
  notes:         '經議價後調整。採輪休每日安排至少 2 人、工時 08:00-17:00。員工月薪不低於 32,450 元（配合 115 年基本薪資調漲）。合約金額 1,645,207 元為未稅小計（不含行政管理費 10%、營業稅 5%；三節慰問金 18,000、勞工健康檢查 3,000 由薪資頁處理；機動人力 4,800 實作實算走機動派工）。',
  createdAt: serverTimestamp(),
}
