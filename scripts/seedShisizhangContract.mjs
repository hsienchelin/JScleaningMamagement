...
//   115 年度總額：125,062 × 12 + 149,265 = 1,500,744 + 149,265 = 1,650,009
//   （與 PDF 拆分 1,650,007 差 2 元，源自材機 53,770/12 捨入）
//
// 註：以下項目不放 monthlyItems，改由薪資頁逐月/逐次處理：
//   1-2 三節慰問金  18,000
//   1-3 勞工健康檢查 3,000
...
const contractData = {
  ...
  sites:         [site],
  amendments:    [],
  notes:         '經議價後調整。採輪休每日安排至少 2 人、工時 08:00-17:00。員工月薪不低於 32,450 元（配合 115 年基本薪資調漲）。合約金額 1,650,007 元為未稅小計（不含行政管理費 10%、營業稅 5%；三節慰問金 18,000、勞工健康檢查 3,000 由薪資頁處理）。',
  createdAt: serverTimestamp(),
}
